It can be the case that code components can return more than on Optionals. 
...
This library is meant to improve the readability by providing fluent API on operating with two Optionals at the same time.
...
But OptionalCombiner transforms it and adds key ideas like combined reduction to Optional class or combined filtering. OptionalCombiner also has some utilities for transofrming the computation to CompletableFutures.
